...
const FALLBACK_LOCATIONS: { label: string; type: string }[] = [
  ...
  // Continents
  { label: 'Africa', type: 'continent' },
  { label: 'Asia', type: 'continent' },
  { label: 'Europe', type: 'continent' },
  { label: 'Latin America', type: 'continent' },
  { label: 'Middle East', type: 'continent' },
  { label: 'Oceania', type: 'continent' },
  { label: 'Caribbean', type: 'continent' },
  ...
  { label: 'Ethiopia', type: 'country' },
  { label: 'Ghana', type: 'country' },
  ...
  { label: 'Rwanda', type: 'country' },
  { label: 'South Africa', type: 'country' },
  { label: 'Tanzania', type: 'country' },
  { label: 'Uganda', type: 'country' },
