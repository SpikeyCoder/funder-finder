-- Improve search_organizations scoring: prioritize exact name matches and whole-word matches
-- over substring matches. Previously "Ford Foundation" ranked below "Fordham University" and
-- "Hartford Hospital" because partial substring matches with higher funding amounts scored better.
